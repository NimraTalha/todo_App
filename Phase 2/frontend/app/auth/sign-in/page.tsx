...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 relative overflow-hidden auth-background">
      ...
      <div className="blob large" style={{ top: '-6rem', left: '-10rem', background: 'radial-gradient(circle at 20% 30%, rgba(139,92,246,0.9), rgba(16,185,129,0.5))' }} />
      <div className="blob medium" style={{ bottom: '-6rem', right: '-6rem', background: 'radial-gradient(circle at 70% 70%, rgba(16,185,129,0.85), rgba(139,92,246,0.4))', animationDelay: '1.5s' }} />
      <div className="blob small" style={{ top: '20%', right: '-4rem', background: 'radial-gradient(circle at 40% 40%, rgba(139,92,246,0.7), rgba(16,185,129,0.2))', animationDelay: '3s' }} />
