    ...
    <div className="min-h-[calc(100vh-80px)] overflow-x-hidden bg-background">
      ...
      <section className="section-horizontal section-vertical bg-muted/30 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="h2 mb-4">Why Todo Pro?</h2>
      ...
      <section className="py-24 px-6 border-y border-ui-border/20 overflow-hidden relative">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <h3 className="h3 mb-2">Used by 10,000+ users worldwide</h3>
          <p className="body uppercase tracking-widest font-xs opacity-50">Trusted across the globe</p>
        </div>
      </section>

      {/* CTA Section */}
      <section className="section-horizontal py-20">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-purple-500 to-green-500 rounded-3xl p-1">
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">Ready to boost your productivity?</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied users who have transformed the way they manage tasks with our intuitive platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth/sign-up">
                <Button variant="primary" size="lg" className="h-14 px-8 rounded-xl bg-gradient-to-r from-purple-600 to-green-600 hover:from-purple-700 hover:to-green-700 text-white">
                  Get Started Free
                </Button>
              </Link>
              <Link href="/dashboard">
                <Button variant="outline" size="lg" className="h-14 px-8 rounded-xl border-2 border-purple-600 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20">
      ...
      <footer className="py-20 px-6 border-t border-ui-border/20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-r from-purple-500 to-green-500 text-white shadow-lg shadow-purple-500/30">
                <CheckCircle2 className="w-5 h-5" strokeWidth={3} />
              </div>
              <h3 className="text-xl font-black tracking-tighter">Todo Pro</h3>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 font-bold text-sm">
              <li><Link href="/dashboard" className="hover:text-purple-600 transition-colors">Features</Link></li>
              <li><Link href="/dashboard" className="hover:text-purple-600 transition-colors">Pricing</Link></li>
              <li><Link href="/dashboard" className="hover:text-purple-600 transition-colors">Integrations</Link></li>
            </ul>
          </div>
          <div className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-ui-border/10 text-center text-sm font-bold opacity-30">
          &copy; 2026 Todo Pro. All rights reserved.
        </div>
      </footer>
    </div>
  );
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="glass-premium rounded-[2rem] p-10 border border-white/10 hover:border-purple-300 transition-all duration-500 hover:-translate-y-2 group">
      <div className="w-14 h-14 rounded-2xl bg-gradient-to-r from-purple-500 to-green-500 flex items-center justify-center text-white mb-8 group-hover:rotate-6 transition-transform duration-500 shadow-inner">
        {icon}
      </div>
