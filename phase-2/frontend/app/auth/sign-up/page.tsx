...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 relative overflow-hidden auth-background">
      ...
      <div className="blob large" style={{ top: '-6rem', right: '-10rem', background: 'radial-gradient(circle at 80% 20%, rgba(139,92,246,0.9), rgba(16,185,129,0.4))' }} />
      <div className="blob medium" style={{ bottom: '-6rem', left: '-6rem', background: 'radial-gradient(circle at 20% 80%, rgba(16,185,129,0.85), rgba(139,92,246,0.4))', animationDelay: '1.2s' }} />
      <div className="blob small" style={{ top: '18%', left: '-4rem', background: 'radial-gradient(circle at 30% 30%, rgba(139,92,246,0.65), rgba(16,185,129,0.2))', animationDelay: '2.8s' }} />
      ...
      <div className="w-full max-w-md animate-welcome z-10">
        <div className="glass-premium rounded-[2.5rem] p-8 md:p-10 border border-white/20 relative z-10">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-purple-500 to-green-500 flex items-center justify-center text-white shadow-xl shadow-purple-500/30 mb-6 animate-float">
              <UserPlus className="w-10 h-10" />
            </div>
            <h2 className="h2 mb-2">Join Todo Pro</h2>
