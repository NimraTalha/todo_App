...
/**
 * UserMenu Component
 * Displays authentication options based on user's status.
 * Shows sign-in/sign-up when not authenticated, and user info with logout when authenticated.
 */
export function UserMenu() {
    ...
    if (isAuthenticated) {
        ...
        // Show sign-in/sign-up options when not authenticated
        return (
