    ...
    return (
      <div className="w-full group">
          ...
          <label
            className={cn(
              ...
              hasError
                ...
                : 'text-purple-700 dark:text-purple-300 group-focus-within:text-purple-600'
            )}
          >
            {label}
          </label>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              'placeholder:text-purple-300 dark:placeholder:text-purple-500',
              'disabled:cursor-not-allowed disabled:opacity-50',
              // Typography
              'text-gray-800 bg-white dark:text-gray-100 dark:bg-purple-900/20',
              // T021: Focus glow - ring-2 ring-indigo-500/20
              'focus:outline-none focus:ring-2',
              hasError
                ? 'border-rose-500 focus:border-rose-500 focus:ring-rose-500/20'
                : 'border-purple-200 focus:border-purple-500 focus:ring-purple-500/20 dark:border-purple-700 dark:focus:border-purple-400 dark:focus:ring-purple-400/20',
        ...
        {helperText && !hasError && (
          <p
            id={`${props.id}-helper`}
            className="mt-2 text-sm text-purple-500 dark:text-purple-400 transition-colors duration-300 ease-out-cubic"
          >
            {helperText}
          </p>
        )}
